      ...
      <div className="space-y-3">
        {DEMO_ACCOUNTS.map((acc) => (
          <button
            ...
            className="w-full flex items-center justify-between p-4 rounded-xl bg-[var(--color-surface)] border border-white/10 hover:bg-white/5 transition-colors text-left group"
          >
            <div>
              <div className="font-medium text-white flex items-center gap-2">
                {acc.label}
                <span className="px-2 py-0.5 rounded text-xs bg-white/10 text-slate-300">{acc.badge}</span>
              </div>
