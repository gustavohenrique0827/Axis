    ...
    <Card className="p-8">
      <form onSubmit={handleLogin} className="space-y-6">
        <div className="space-y-2">
          <label className="text-sm text-slate-400">E-mail Corporativo</label>
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-[var(--color-surface)] border border-white/10 rounded-lg pl-10 pr-4 py-3 text-sm focus:outline-none focus:border-[#2563EB] focus:ring-1 focus:ring-[#2563EB] transition-colors"
        ...
        <Button type="submit" disabled={loading} className="w-full py-6 bg-[#2563EB] hover:bg-blue-600 rounded-lg text-md group">
