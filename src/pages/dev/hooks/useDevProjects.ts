...
const MOCK_PROJECTS: DevProject[] = [
  { id: "1", name: "Plataforma S.P.Y. CRM", description: "Sistema principal de CRM e gestão multitenant da G-Tech.", status: "Em Desenvolvimento", progress: 72, stack: ["React", "TypeScript", "Supabase"], team: ["G.H.", "M.L.", "A.R."], lastCommit: "2h atrás", openIssues: 8, sprints: 6, stars: 14 },
  ...
  { id: "6", name: "SDK de Integrações", description: "SDK JavaScript/TypeScript para parceiros integrarem o S.P.Y. em suas plataformas.", status: "Concluído", progress: 100, stack: ["TypeScript", "npm", "Vitest"], team: ["M.L."], lastCommit: "2 semanas atrás", openIssues: 0, sprints: 2, stars: 33 },
];
