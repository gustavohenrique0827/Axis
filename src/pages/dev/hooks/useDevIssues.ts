...
const MOCK_ISSUES: DevIssue[] = [
  ...
  { id: 246, issueNumber: 246, title: "Layout quebrado em mobile no pipeline Kanban", description: "Cards do pipeline ficam sobrepostos em telas menores que 375px.", severity: 'alto', status: 'em review', project: "Plataforma Axis CRM", assignee: "T.S.", reporter: "A.R.", createdAt: "3h atrás", comments: 2, labels: ["mobile", "crm", "ui"] },
  ...
  { id: 244, issueNumber: 244, title: "Filtros de data no relatório financeiro retornam incorreto", description: "Ao filtrar por mês, o sistema inclui transações do mês anterior.", severity: 'alto', status: 'aberto', project: "Plataforma Axis CRM", assignee: "M.L.", reporter: "P.C.", createdAt: "1 dia atrás", comments: 3, labels: ["financeiro", "relatórios"] },
  { id: 243, issueNumber: 243, title: "Erro 403 ao acessar configurações de empresa", description: "Usuários com role 'Administrador' recebem 403 ao editar dados da empresa.", severity: 'médio', status: 'em andamento', project: "Plataforma Axis CRM", assignee: "G.H.", reporter: "L.M.", createdAt: "2 dias atrás", comments: 4, labels: ["auth", "permissões"] },
  ...
  { id: 241, issueNumber: 241, title: "Botão de exportar CSV não responde no Firefox", description: "No Firefox versão 118+, o botão de exportação de relatório não dispara o download.", severity: 'baixo', status: 'aberto', project: "Plataforma Axis CRM", assignee: "-", reporter: "M.L.", createdAt: "4 dias atrás", comments: 1, labels: ["browser", "exportação"] },
