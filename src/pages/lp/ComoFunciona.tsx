      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
        {STEPS.map((s, i) => (
          <FadeIn key={s.n} delay={i * 0.1} className={i % 2 === 1 ? "lg:mt-9" : ""}>
            <div className="group relative h-full flex flex-col p-6 rounded-2xl bg-white border border-slate-200 shadow-sm hover:-translate-y-1 hover:border-slate-300 hover:shadow-lg transition-all duration-300">
