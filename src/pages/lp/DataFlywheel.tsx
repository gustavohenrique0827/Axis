      ...
      <FadeIn>
        <div className="flex flex-col items-center gap-10">
          <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-7 gap-3 sm:gap-4 w-full max-w-3xl">
            {INPUTS.map((inp) => (
              <div key={inp.label} className="flex flex-col items-center gap-2 p-3 sm:p-4 rounded-xl bg-white border border-slate-200 shadow-sm">
          ...
          <div className="px-8 py-4 rounded-2xl bg-gradient-to-r from-blue-600 to-violet-600 shadow-lg shadow-blue-500/20">
