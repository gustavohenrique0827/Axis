    ...
    <PageContainer
      ...
      actions={
        <div className="flex gap-2">
          <Button variant="outline" className="border-white/10 bg-[var(--color-surface-elevated)] text-slate-300 h-11 px-6 rounded-xl text-xs">
            Exportar PDF
          </Button>
          <select className="bg-[var(--color-surface-elevated)] border border-white/10 rounded-xl px-4 py-2 text-xs outline-none focus:border-slate-500 text-white h-11">
