      ...
      <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-[var(--color-surface)] border border-[var(--color-border-subtle)] p-3 rounded-xl flex items-center justify-between">
          <div>
            ...
            <p className="text-xs font-bold text-[var(--color-text-primary)] mt-0.5">Sem Recomendação</p>
          </div>
        ...
        <div className="bg-[var(--color-surface)] border border-[var(--color-border-subtle)] p-3 rounded-xl flex items-center justify-between">
          <div>
            ...
            <p className="text-xs font-bold text-[var(--color-text-primary)] mt-0.5">Sem Desconto</p>
          </div>
        ...
        <div className="bg-[var(--color-surface)] border border-[var(--color-border-subtle)] p-3 rounded-xl flex items-center justify-between">
          ...
          <span className="text-xs font-bold text-[var(--color-text-primary)] font-mono mt-0.5">0%</span>
        </div>
      </div>
    </Card>
  );
