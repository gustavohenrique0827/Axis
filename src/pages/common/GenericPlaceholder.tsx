...
export default function GenericPlaceholder() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-slate-400 space-y-6">
      <div className="w-24 h-24 rounded-3xl bg-[var(--color-premium-black)] border border-slate-700/50 flex items-center justify-center text-slate-400">
      ...
      <button
        ...
        className="px-6 py-2.5 bg-[var(--color-primary-blue)] hover:bg-blue-700 text-white font-medium rounded-xl transition-all active:scale-95"
      >
