...
export function PipelineKPIs({ total, hot, closed, winRate, formattedTotalValue }: PipelineKPIsProps) {
  return (
    <div className="grid grid-cols-2 md:grid-cols-5 gap-2 shrink-0">
      <Card className="p-3 border-blue-500/20 bg-[var(--color-surface-elevated)]/80 backdrop-blur-xl hover:scale-[1.02] transition-all">
      ...
      <Card className="p-3 border-yellow-500/20 bg-[var(--color-surface-elevated)]/80 backdrop-blur-xl hover:scale-[1.02] transition-all">
        <div className="flex justify-between items-center mb-1">
      ...
      <Card className="p-3 border-emerald-500/20 bg-[var(--color-surface-elevated)]/80 backdrop-blur-xl hover:scale-[1.02] transition-all">
        <div className="flex justify-between items-center mb-1">
      ...
      <Card className="p-3 border-white/5 bg-[var(--color-surface-elevated)]/80 backdrop-blur-xl hover:scale-[1.02] transition-all">
        <div className="flex justify-between items-center mb-1">
      ...
      <Card className="p-3 border-white/5 bg-[var(--color-surface-elevated)]/80 backdrop-blur-xl hover:scale-[1.02] transition-all col-span-2 md:col-span-1">
        <div className="flex justify-between items-center mb-1">
