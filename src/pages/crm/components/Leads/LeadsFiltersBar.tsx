    ...
    <div className="flex flex-wrap items-center gap-2 mb-4">
      <div className="relative flex-1 min-w-[200px]">
        ...
        <input
          ...
          className="bg-[var(--color-surface-elevated)]/50 border border-white/5 rounded-xl pl-9 pr-4 py-2.5 text-sm text-white focus:outline-none focus:border-white/20 w-full"
        />
      </div>
      ...
      <button
        ...
        className="flex items-center gap-1.5 bg-[var(--color-surface-elevated)]/80 border border-white/5 rounded-xl px-3 h-[42px] text-xs text-slate-400 hover:text-white transition-colors cursor-pointer"
      >
