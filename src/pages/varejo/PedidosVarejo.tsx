        ...
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-[var(--color-surface)] border border-[var(--color-border-default)] rounded-2xl p-6 w-full max-w-md shadow-2xl space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-bold text-[var(--color-text-primary)]">Registrar Pedido de Balcão</h3>
            ...
            <form onSubmit={handleCreate} className="space-y-3">
              ...
              <div>
                <label className="text-[11px] font-bold text-[var(--color-text-muted)] block mb-1">Itens Vendidos</label>
                <textarea
                  rows={2}
                  required
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="text-[11px] font-bold text-[var(--color-text-muted)] block mb-1">Forma de Pagamento</label>
                  <select
                    value={formaPagto}
