    ...
    >
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        ...
        <div className="flex gap-2">
           <Button variant="ghost" size="sm" className="bg-[#111827] border border-white/10 text-slate-400 hover:text-white text-xs">Todos os Canais</Button>
           <Button variant="ghost" size="sm" className="bg-[#111827] border border-white/10 text-slate-400 hover:text-white text-xs">Apenas Meta</Button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-4">
          {posts.map(post => (
            <Card key={post.id} className="p-5 bg-[#111827] border-white/5 flex flex-col md:flex-row gap-6 hover:bg-[#1E293B] transition-colors relative overflow-hidden group">
        ...
        <div className="space-y-6">
          ...
          <Card className="p-6 bg-gradient-to-br from-indigo-500/20 to-[#111827] border-indigo-500/20">
