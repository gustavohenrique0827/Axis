              ...
              {instances.map(inst => (
                <div key={inst.id} className="mt-3 space-y-2">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs font-mono text-slate-400">
                    ...
                    <div className="col-span-2 truncate">🔑 Token: <span className="text-slate-350">{inst.apiKey}</span></div>
                  </div>
                </div>
              ))}
              {instances.length === 0 && (
            ...
            <div className="space-y-2 pt-4 border-t border-white/5">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <input
                  ...
                  className="flex-1 bg-[#0B1120] border border-white/10 rounded-xl px-4 py-2 text-sm text-slate-200 focus:border-blue-500 focus:outline-none w-full"
                />
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3 pt-2">
                <div className="space-y-1">
                  ...
                  <select value={selectedContactId} onChange={e => setSelectedContactId(e.target.value)} className="w-full bg-[#0B1120] border border-white/10 rounded-xl p-2.5 text-xs text-slate-300 focus:outline-none">
