      ...
      <Card className="lg:col-span-2 p-6">
        <div className="flex flex-col md:flex-row justify-between items-start mb-6 gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-rose-500" /><span className="text-xs text-slate-400">Atrasado/Cancelado</span></div>
          </div>
        </div>
        {totalAppointments === 0 ? (
          ...
          <div className="h-[320px] -mx-4">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={clinicData}>
                ...
                <Tooltip contentStyle={{ backgroundColor: 'var(--color-surface)', border: '1px solid #ffffff05', borderRadius: '8px' }} itemStyle={{ fontSize: '11px' }} />
