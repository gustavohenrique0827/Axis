...
export function AgendaDetailPanel({ selectedApt, onClose, onCancel }: AgendaDetailPanelProps) {
  return (
    <AnimatePresence>
      {selectedApt && (
          ...
          >
            <div className="p-8 border-b border-white/5 bg-gradient-to-br from-blue-600/5 to-transparent">
              <div className="flex items-center justify-between mb-8">
                <h3 className="text-[10px] font-black text-blue-400 uppercase tracking-[0.3em]">Detalhes da Consulta</h3>
                <button onClick={onClose} className="p-2 hover:bg-white/5 rounded-xl text-slate-400"><X className="w-5 h-5" /></button>
              </div>
              <div className="flex items-center gap-6 mb-8">
                <div className="w-20 h-20 rounded-3xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center text-3xl font-black text-blue-500">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-4">
                    <span className="text-[9px] font-black uppercase text-blue-400 bg-blue-500/10 px-2 py-1 rounded-lg">Premium axis</span>
            ...
            <div className="flex-1 overflow-y-auto p-8 space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="p-4 bg-white/5 rounded-2xl border border-white/5">
                    ...
                    <p className="text-xs font-medium text-slate-300 leading-relaxed italic border-l-2 border-blue-500/40 pl-3">
              ...
              <div className="space-y-4 pt-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Button className="h-12 rounded-2xl bg-blue-600 hover:bg-blue-700 text-[10px] font-black uppercase gap-2">Iniciar Atendimento</Button>
                  <Button variant="outline" className="h-12 rounded-2xl border-white/10 text-[10px] font-black uppercase">Remarcar</Button>
                  <Button
                    type="button"
                    variant="outline"
                    disabled={selectedApt.status === 'Cancelado'}
                    onClick={() => onCancel?.(selectedApt.id)}
                    className="h-12 rounded-2xl border-white/10 text-[10px] font-black uppercase text-rose-400 border-rose-500/10 disabled:opacity-40"
                  >
                    {selectedApt.status === 'Cancelado' ? 'Cancelado' : 'Cancelar'}
                  </Button>
