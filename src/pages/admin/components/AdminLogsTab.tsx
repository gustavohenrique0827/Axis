  ...
  return (
    <div className="space-y-4 animate-in fade-in duration-300">
      <div className="flex gap-2 opacity-50">
        <Button className="bg-[var(--color-surface-elevated)] text-white" disabled>
          <Download className="w-4 h-4 mr-2" /> Exportar CSV
        </Button>
      </div>
      <div className="bg-[var(--color-surface)] border border-white/10 rounded-xl font-mono text-[11px] sm:text-[12px] p-4 sm:p-6 shadow-2xl overflow-hidden relative min-h-[400px]">
