...
export const defaultLeads: Lead[] = [
  {
    ...
    source: "Google Ads",
    title: "Implantação ERP + CRM Axis",
    priority: "Alta",
    stageId: "1",
    pipelineId: "comercial",
    scoreIA: 94,
    temperature: "quente",
    iaSummary: "Diretoria busca substituir sistema legado por solução integrada Axis. Orçamento aprovado.",
    timeIdle: 2,
  ...
  },
  {
    ...
    source: "Indicação",
    title: "Licença Axis Saúde + Telemedicina",
    priority: "Alta",
    stageId: "3",
    pipelineId: "comercial",
    scoreIA: 88,
  ...
  },
  {
    ...
    title: "Portal EAD + Certificação Axis",
    priority: "Alta",
    stageId: "5",
    pipelineId: "comercial",
    scoreIA: 98,
